<%-- 
    Document   : clothingPreferences
    Created on : 04-Mar-2021, 10:35:35
...
<html lang="en">
    <head>
        ...
        <title>Swapperz - My Preferences </title>
        ...
        <div class="container">
            ...
            <div class="container text-center">
                <div class="row d-inline-block p-2" id='userDetails'>
                    ...
                    <h4 class="mb-4">Your Brand Preferences:</h4>
                    <%
                        ...
                        <div class="row p-2  text-center">
                            <div class="col-4 d-inline-block p-1">
                                ...
                                <select class='form-control' name="brandId">
                                    <%
                                        ArrayList<Brand> brandList = bDao.getAllBrands();
                            ...
                            <div class='row p-2'>
                                <input type="submit" value="Change" class="btn float-right btn-primary font-weight-bold">
                            </div>
                            <input type="hidden" name="action" value="editClothingPreferences">
                            </form>
                        </div>
                        <!--PREFERENCES-->
                        <div class='row' id='userPreferences'>
