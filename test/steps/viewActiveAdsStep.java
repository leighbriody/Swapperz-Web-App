 ...
 */
public class viewActiveAdsStep {

    private WebDriver driver = null;

    @Given("^a user is logged onto their profile page$")
    public void a_user_is_logged_onto_their_profile_page() throws Throwable {
    ...
    @When("^the user clicks view active ads$")
    public void the_user_clicks_view_active_ads() throws Throwable {
        driver.findElement(By.xpath("//a[@id='activeAdvertisements']")).click();
        
    }

    @Then("^the user will be able to see their active ads$")
    public void the_user_will_be_able_to_see_their_active_ads() throws Throwable {
        String URL = driver.getCurrentUrl();
        assertEquals(URL, "http://localhost:8084/SwapperzWebApplication/myProfile.jsp?adds=forSale");
    }
}
